...
const Footer = () => {
  return (
    <footer className="w-full min-h-[40vh] bg-gradient-to-r from-gray-900 via-black to-gray-900 text-amber-400 sm:p-6 dark:bg-gray-800 z-30">
      <div className="mx-auto max-w-7xl pt-12">
        ...
        <hr className="my-6 border-amber-400 sm:mx-auto dark:border-amber-400 lg:my-8" />
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-amber-400 sm:text-center dark:text-gray-400">
            © 2023 - 2024{" "}
            <a href="#" className="hover:underline">
              blooming brands™
            </a>
