...
export default function Hero() {
  return (
    <div className="relative w-full lg:h-[80vh] sm:h-[50vh] flex flex-col justify-center items-center bg-fixed bg-[url('https://images.ctfassets.net/wp1lcwdav1p1/5lai1xeGFtJ2gA6fuYip1S/72663c00791b3b87246c03b4d88e3936/GettyImages-1132115579__1_.jpg')] bg-cover bg-top bg-no-repeat">
