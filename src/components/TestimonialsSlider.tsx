        ...
        <Slider {...settings} className="h-full">
            ...
            <figure className="max-w-screen-md mx-auto text-center">
              ...
              <blockquote>
                <p className="text-2xl italic font-medium text-gray-900 dark:text-white">
                  ...
                  delivered on their promise. We&apos;ll be coming back with
                  more projects&quot;
                </p>
              </blockquote>
          ...
          <div>
            <figure className="max-w-screen-md mx-auto text-center">
              ...
              <blockquote>
                <p className="text-2xl italic font-medium text-gray-900 dark:text-white">
                  &quot;Blooming Brands software team was able to collaborate
                  with our in-house team, together we created a modern intranet
                  website for internal use&quot;
                </p>
              </blockquote>
              <figcaption className="flex items-center justify-center mt-6 space-x-3">
                {/* <Image
